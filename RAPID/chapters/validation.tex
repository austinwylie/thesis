...
% PolyView validates requirements
...
% These requirements can be summarized into short statements such as ``GeoJSON files can be added to the system'' or ``Atmospheric data can be retrieved for any region.'' Valid responses rank from 1 to 5---1 being ``Totally disagree'' and 5 being ``Totally agree.''
